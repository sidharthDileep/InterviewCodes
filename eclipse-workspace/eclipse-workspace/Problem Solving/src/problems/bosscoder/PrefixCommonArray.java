...
public class PrefixCommonArray {
	/*
	 * Problem Statement: You are given two 0-indexed integer permutations A and B
	 * of length n.
	 * 
	 ...
	 * 
	 * Input: A = [1,3,2,4], B = [3,1,2,4] Output: [0,2,3,4] Explanation: At i = 0:
	 * no number is common, so C[0] = 0. At i = 1: 1 and 3 are common in A and B, so
	 * C[1] = 2. At i = 2: 1, 2, and 3 are common in A and B, so C[2] = 3. At i = 3:
	 * 1, 2, 3, and 4 are common in A and B, so C[3] = 4.
	 * 
